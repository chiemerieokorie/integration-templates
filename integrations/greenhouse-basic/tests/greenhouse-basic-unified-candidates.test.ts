...
import fetchData from '../syncs/unified-candidates.js';

describe('greenhouse-basic unified-candidates tests', () => {
    const nangoMock = new global.vitest.NangoSyncMock({
        dirname: __dirname,
        name: 'unified-candidates',
        Model: 'StandardCandidate'
    });

    const models = 'StandardCandidate'.split(',');
